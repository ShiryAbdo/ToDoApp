...
class RegisterActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun postDataToSQLite() {
        ...
        if (!databaseHelper!!.DatabaseHelperNotes(this@RegisterActivity).checkUser(textInputEditTextEmail!!.text.toString().trim())) {

            var user = User(name = textInputEditTextName!!.text.toString().trim(),
                    email = textInputEditTextEmail!!.text.toString().trim(),
                    password = textInputEditTextPassword!!.text.toString().trim())

            databaseHelper!!.DatabaseHelperNotes(this@RegisterActivity).addUser(user)
