...
import com.eramiexample.firstkotlinapp.helpers.InputValidation
import com.eramiexample.firstkotlinapp.sql.DbManager


class LogUserInActivity : AppCompatActivity(), View.OnClickListener {

    private val activity = this@LogUserInActivity
    ...
    private lateinit var databaseHelper: DbManager
    ...
    private fun initObjects() {
        ...
        databaseHelper = DbManager(activity)
    ...
    private fun verifyFromSQLite() {
        ...
        if (databaseHelper!!.DatabaseHelperNotes(this@LogUserInActivity).checkUser(textInputEditTextEmail!!.text.toString().trim { it <= ' ' }, textInputEditTextPassword!!.text.toString().trim { it <= ' ' })) {
