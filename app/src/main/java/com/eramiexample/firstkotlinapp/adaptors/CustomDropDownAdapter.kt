...
class CustomDropDownAdapter(val context: Context, var listItemsTxt: ArrayList<TagsData>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.imgDropDownMenuIcon.setImageResource(listItemsTxt.get(position).imageView)
        return view
    }
    ...
    private class ItemRowHolder(row: View?) {
        ...
        init {
            ...
            this.imgDropDownMenuIcon=row?.findViewById(R.id.imgDropDownMenuIcon)as ImageView
        }
    }
}